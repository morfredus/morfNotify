...
// -----------------------------------------------------------------------------
// NotifierRegistry : collection des destinations et point de DISTRIBUTION.
//
...
// -----------------------------------------------------------------------------
class NotifierRegistry : public QObject, public morfbeacon::IMetricsProvider {
    Q_OBJECT
public:
    explicit NotifierRegistry(QObject* parent = nullptr);
    ~NotifierRegistry() override;
